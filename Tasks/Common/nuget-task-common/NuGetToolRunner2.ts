...
function prepareNuGetExeEnvironment(
    ...
    if (settings.credProviderFolder != null || originalCredProviderPath != null) {
        let credProviderPath = buildCredProviderPath(settings.credProviderFolder, originalCredProviderPath);
    ...
    if (settings.V2CredProviderPath != null || envVarCredProviderPathV2 != null) {
        let credProviderPath = buildCredProviderPath(settings.V2CredProviderPath, envVarCredProviderPathV2);
